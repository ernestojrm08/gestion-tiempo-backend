...
export async function action_eventos_obtenerActividades() {
    ...
    <label>
        Completada:<input type="checkbox" id="completada"> 
    </label>

    <div>
        <button type="submit" id="button_form">Agregar Actividad</button>
        <button type="button" id="button_limpiar">Limpiar Formulario</button>
    </div>
</form>
        <table>
            <thead>
